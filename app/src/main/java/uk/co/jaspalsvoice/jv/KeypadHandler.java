 ...
 */
public class KeypadHandler extends android.os.Handler {

    private static final String TAG = KeypadHandler.class.getSimpleName();
    ...
    public KeypadHandler(int highlightColor) {
